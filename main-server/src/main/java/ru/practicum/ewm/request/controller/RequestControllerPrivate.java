...
public class RequestControllerPrivate {
    ...
    @PostMapping
    public ResponseEntity<ParticipationRequestDto> create(@PositiveOrZero @PathVariable Long userId,
    ...
    public ResponseEntity<ParticipationRequestDto> cancelRequest(@PositiveOrZero @PathVariable Long userId,
